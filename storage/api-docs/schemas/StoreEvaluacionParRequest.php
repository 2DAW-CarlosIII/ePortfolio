...
/**
 * @OA\Schema(
 *     schema="StoreEvaluacionParRequest",
 *     type="object",
 *     title="Store EvaluacionPar Request",
 *     description="Request body for creating a new EvaluacionPar",
 *     required={"puntuacion_sugerida", "recomendacion", "justificacion", "fecha_evaluacion"},
 *         @OA\Property(
 ...
 * )
 */
class StoreEvaluacionParRequestSchema
{
