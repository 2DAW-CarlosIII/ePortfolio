...
class StoreEvaluacionParRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'asignacion_revision_id' => ['required', 'integer', 'exists:asignaciones_revision,id'],
            'revisor_id' => ['required', 'integer', 'exists:users,id'],
            'puntuacion_sugerida' => ['required', 'numeric', 'between:0,10'],
            'recomendacion' => ['required', 'in:aprobar,mejorar,rechazar'],
