...
/**
 * @OA\Get(
 *     path="/modulos_formativos/import",
 *     summary="Obtener información para importar Módulos Formativos",
 *     description="Devuelve los campos importables y la URL del template para Módulos Formativos",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\Response(
 *         response=200,
 ...
 *         @OA\JsonContent(
 *             type="object",
 *             @OA\Property(property="resource", type="string", example="ModuloFormativo"),
 *             @OA\Property(property="template_url", type="string", example="http://eportfolio.test/api/v1/import/template/modulos_formativos")
 *         )
 *     )
 * )
 */
 ...
 * @OA\Post(
 *     path="/modulos_formativos/import",
 *     summary="Importar Módulos Formativos desde CSV",
 *     description="Procesa un archivo CSV e importa los Módulos Formativos contenidos en él",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\RequestBody(
 *         required=true,
...
/**
 * @OA\Get(
 *     path="/modulos_formativos/import/template",
 *     summary="Descargar template CSV para Módulos Formativos",
 *     description="Descarga un archivo CSV de ejemplo con la estructura correcta para importar Módulos Formativos",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\Response(
 *         response=200,
 ...
 *             @OA\Schema(type="string", example="attachment; filename='modulos_formativos_template.csv'")
 *         ),
 *         @OA\Header(
 *             header="Content-Type",
