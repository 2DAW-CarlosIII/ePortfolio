...
/**
 * @OA\Get(
 *     path="/matriculas/import",
 *     summary="Obtener información para importar Matriculas",
 *     description="Devuelve los campos importables y la URL del template para Matriculas",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\Response(
 *         response=200,
 ...
 *         @OA\JsonContent(
 *             type="object",
 *             @OA\Property(property="resource", type="string", example="Matricula"),
 *             @OA\Property(property="template_url", type="string", example="http://eportfolio.test/api/v1/import/template/matriculas")
 *         )
 *     )
 * )
 */
 ...
 * @OA\Post(
 *     path="/matriculas/import",
 *     summary="Importar Matrículas desde CSV",
 *     description="Procesa un archivo CSV e importa los Matrículas contenidos en él",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\RequestBody(
 *         required=true,
...
/**
 * @OA\Get(
 *     path="/matriculas/import/template",
 *     summary="Descargar template CSV para Matrículas",
 *     description="Descarga un archivo CSV de ejemplo con la estructura correcta para importar Matrículas",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\Response(
 *         response=200,
 ...
 *             @OA\Schema(type="string", example="attachment; filename='matriculas_template.csv'")
 *         ),
 *         @OA\Header(
 *             header="Content-Type",
