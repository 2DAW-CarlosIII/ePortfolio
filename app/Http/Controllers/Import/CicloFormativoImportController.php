...
/**
 * @OA\Get(
 *     path="/ciclos_formativos/import",
 *     summary="Obtener información para importar Ciclos Formativos",
 *     description="Devuelve los campos importables y la URL del template para Ciclos Formativos",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\Response(
 *         response=200,
 ...
 *         @OA\JsonContent(
 *             type="object",
 *             @OA\Property(property="resource", type="string", example="CicloFormativo"),
 *             @OA\Property(property="template_url", type="string", example="http://eportfolio.test/api/v1/import/template/ciclos_formativos")
 *         )
 *     )
 * )
 */
 ...
 * @OA\Post(
 *     path="/ciclos_formativos/import",
 *     summary="Importar Ciclos Formativos desde CSV",
 *     description="Procesa un archivo CSV e importa los Ciclos Formativos contenidos en él",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\RequestBody(
 *         required=true,
...
/**
 * @OA\Get(
 *     path="/ciclos_formativos/import/template",
 *     summary="Descargar template CSV para Ciclos Formativos",
 *     description="Descarga un archivo CSV de ejemplo con la estructura correcta para importar Ciclos Formativos",
 *     security={{"sanctum":{}}},
 *     tags={"Import"},
 *     @OA\Response(
 *         response=200,
 ...
 *             @OA\Schema(type="string", example="attachment; filename='ciclos_formativos_template.csv'")
 *         ),
 *         @OA\Header(
 *             header="Content-Type",
